...
export default function LibraryPage() {
  ...
  const filtered = useMemo(() => {
    ...
    const f = items.filter((v) => {
      ...
      if (
        tq &&
        !v.title.toLowerCase().includes(tq)
      ) {
        return false;
      }
  ...
  <div className="app library-app">
    ...
    <section className="controls library-controls">
      ...
      <select
        ...
        onChange={(e) =>
          setStatusFilter(
            e.target.value as CollectStatus | "all"
          )
        }
      >
        ...
        {paged.map((item) => (
          ...
          >
            ...
            <div className="meta">
              ...
              <div
                className={`status status-${item.collectStatus}`}
              >
                {item.collectStatus}
              </div>
            </div>
    ...
    {selected && (
      ...
      >
        ...
        >
          ...
          <p>
            {selected.sellerName || "unknown"}
          </p>

          <p className="path">
            {selected.pathHint || "(path hidden)"}
          </p>

          <div className="dialog-actions">
            <button
              onClick={() =>
                void openFolder(selected)
              }
            >
              Open folder
            </button>
